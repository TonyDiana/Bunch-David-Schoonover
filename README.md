...
=====
    ...
    ESTE TRABAJO PERTENECE POR COMPLETO A
    
        David Schoonover
    
    EL CUAL SE ENCUENTRA DISPONIBLE EN
    
        https://github.com/dsc/bunch.

    ESTA ES UNA SIMPLE ADAPTACIÓN Y MEJORA, EN LA QUE SE ELIMINAN ERRORES DE
    FLAKE8, CORRECCIONES A LAS NECESIDADES DE PYTHON 3.8 (Aunque se conserva
    la posibilidad de funcionar en Python 2) Y SE ADAPTA PARA SU UTILIZACIÓN
    SIN INSTALACIÓN, SINO PERMITIENDO LA INCORPORACIÓN DEL CÓDIGO COMO PARTE
    DE UN PROYECTO PERSONAL.

    SE AGRADECE AL AUTOR Y SE ACLARA NUEVAMENTE QUE ESTE REPOSITORIO ES,
    SIMPLEMENTE, UNA ADAPTACIÓN, SIN APENAS MEJORAS, POR PARTE DE Tony Diana.
